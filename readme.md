...
東京大学工学部電気系3年後期実験の種目「マイクロプロセッサの設計と実装」の成果物です。
10日間の実験でRISC-VマイクロプロセッサをVerilogを用いて実装しました。
最終発表スライド: https://drive.google.com/file/d/1_5ev7gBhKHMKQXpaOR-nS8pSaXTpHyO-/view?usp=drive_link
